...
const index = () => {
  return (
    ...
    <div className="rounded-sm " >
            <h5 className=" lg:text-[85px] sm:text-[25px] font-bold tracking-tight text-gray-300 dark:text-white">
              Book 1 on 1
            </h5>
          </div>
          ...
          <div className='flex gap-6 '>
              ...
              <button type="button" className=' text-[30px] font-bold w-[17rem] h-[7rem] rounded-[5rem] bg-[#87CEEB]' >Aryan</button>

              <button type="button" className=' text-[30px] font-bold w-[17rem] h-[7rem] rounded-[5rem] bg-[#87CEEB]' >Deepanshu</button>
